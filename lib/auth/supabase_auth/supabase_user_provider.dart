...
class MEDPProjectServiceAndRequestersSupabaseUser extends BaseAuthUser {
  MEDPProjectServiceAndRequestersSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> mEDPProjectServiceAndRequestersSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          MEDPProjectServiceAndRequestersSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
