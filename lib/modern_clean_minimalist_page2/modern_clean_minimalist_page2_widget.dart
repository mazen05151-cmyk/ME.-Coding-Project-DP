...
import 'modern_clean_minimalist_page2_model.dart';
export 'modern_clean_minimalist_page2_model.dart';
...
class ModernCleanMinimalistPage2Widget extends StatefulWidget {
  const ModernCleanMinimalistPage2Widget({super.key});

  static String routeName = 'ModernCleanMinimalistPage2';
  static String routePath = '/modernCleanMinimalistPage2';

  @override
  State<ModernCleanMinimalistPage2Widget> createState() =>
      _ModernCleanMinimalistPage2WidgetState();
}

class _ModernCleanMinimalistPage2WidgetState
    extends State<ModernCleanMinimalistPage2Widget> {
  late ModernCleanMinimalistPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModernCleanMinimalistPage2Model());
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'vq21i20o' /* Request Sent Successfully! */,
                          ),
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'qicja9lr' /* Your volunteer booking has bee... */,
                          ),
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
