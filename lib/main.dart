...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = mEDPProjectServiceAndRequestersSupabaseUserStream()
      ..listen((user) {
  ...
  Widget build(BuildContext context) {
    return MaterialApp.router(
      ...
      title: 'MEDP Project Service and Requesters',
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPageName = 'A-homePage_MAIN';
  ...
  Widget build(BuildContext context) {
    final tabs = {
      'A-homePage_MAIN': AHomePageMAINWidget(),
      'A-UserHistoryRequester': AUserHistoryRequesterWidget(),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        selectedItemColor: Color(0xFF8BCF4E),
