    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case LocationLogsRow:
            return LocationLogsRow(data);
          case MessagesRow:
            return MessagesRow(data);
          case PartnerCompaniesRow:
            return PartnerCompaniesRow(data);
          case PointsLedgerRow:
            return PointsLedgerRow(data);
          case ProfilesRow:
            return ProfilesRow(data);
          case RatingsRow:
            return RatingsRow(data);
          case RedemptionsRow:
            return RedemptionsRow(data);
          case RewardsRow:
            return RewardsRow(data);
          ...
          case VerificationDocumentsRow:
            return VerificationDocumentsRow(data);
          case VolunteerDataRow:
            return VolunteerDataRow(data);
          default:
            return null;
        }
