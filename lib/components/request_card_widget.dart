...
class RequestCardWidget extends StatefulWidget {
  const RequestCardWidget({
    ...
    String? rating,
  })  : this.taskName = taskName ?? 'Grocery Delivery',
        this.status = status ?? 'On the way',
        this.timeEstimate = timeEstimate ?? '5-10 mins',
        this.volunteerName = volunteerName ?? 'Ahmed K.',
        this.rating = rating ?? '4.8 (124)';
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl:
                              'https://dimg.dreamflow.cloud/v1/image/volunteer%20profile%20photo',
                          width: 40.0,
                          height: 40.0,
                          fit: BoxFit.cover,
