...
import 'request_card3_model.dart';
export 'request_card3_model.dart';

class RequestCard3Widget extends StatefulWidget {
  const RequestCard3Widget({
    super.key,
    String? requestTitle,
    String? status,
    ...
    String? volunteerRating,
        ...
        this.volunteerName = volunteerName ?? 'Ahmed K.',
  ...
  @override
  State<RequestCard3Widget> createState() => _RequestCard3WidgetState();
}

class _RequestCard3WidgetState extends State<RequestCard3Widget> {
  late RequestCard3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestCard3Model());
