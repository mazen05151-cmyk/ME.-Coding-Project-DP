...
import 'a_user_history_requester_model.dart';
export 'a_user_history_requester_model.dart';

class AUserHistoryRequesterWidget extends StatefulWidget {
  const AUserHistoryRequesterWidget({super.key});

  static String routeName = 'A-UserHistoryRequester';
  static String routePath = '/aUserHistoryRequester';

  @override
  State<AUserHistoryRequesterWidget> createState() =>
      _AUserHistoryRequesterWidgetState();
}

class _AUserHistoryRequesterWidgetState
    extends State<AUserHistoryRequesterWidget> with TickerProviderStateMixin {
  late AUserHistoryRequesterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AUserHistoryRequesterModel());
                                  ...
                                  child: FutureBuilder<List<Map<String, dynamic>>>(
                                    future: () async {
                                      ...
                                      final response = await supabase
                                          .from('bookings')
                                          .select('*, volunteer_id:profiles(display_name, photo_url)')
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          final volunteerProfile = booking['volunteer_id'] as Map<String, dynamic>?;
                                          ...
                                          final photoUrl = volunteerProfile?['photo_url'] ?? 'https://images.unsplash.com/photo-1534528741775-53994a69daeb';
                                          final displayName = volunteerProfile?['display_name'] ?? 'Volunteer';
